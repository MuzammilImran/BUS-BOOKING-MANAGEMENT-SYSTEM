...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:8%">
         <div class="panel-heading">
                    ...
                    <div class="col-lg-2"><a href="#" style="padding: 5px;" class="btn btn-danger" id="hrefBackUrl" runat="server" title="Back To Search List"><i class="fa fa-backward"></i>&nbsp;Back To Search List</a></div>
                </div>
                <br />
